...
print '<tr class="oddeven">';
print '<td valign="top">';
print $form->textwithtooltip( $langs->trans('questionnaireConfAnswerDeadline') , $langs->trans('questionnaireConfAnswerDeadlineHelp'),2,1,img_help(1,''));
print '</td>';
print '<td align="center" width="20">&nbsp;</td>';
print '<td align="right" width="300">';
print '<input type="number" id="answer_deadline" name="answer_deadline" value="' . $object->answer_deadline . '"  />';
if(empty($object->answer_deadline) && !empty($conf->global->QUESTIONNAIRE_DEFAULT_ANSWER_DEADLINE)){
	print ' ( ' . $langs->trans('Default') . ': ' . $conf->global->QUESTIONNAIRE_DEFAULT_ANSWER_DEADLINE . ' )';
}
print '</td></tr>';
