...
/**
 * 	\file		core/triggers/interface_99_modMyodule_questionnairetrigger.class.php
 * 	\ingroup	questionnaire
 * 	\brief		Sample trigger
 * 	\remarks	You can create other triggers by copying this one
 * 				- File name should be either:
 * 					interface_99_modQuestionnaire_Mytrigger.class.php
 ...
 * Trigger class
 */
class Interfacequestionnairetrigger
{
