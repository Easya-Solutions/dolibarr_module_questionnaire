 ...
 */
class questionnairebox extends ModeleBoxes
{

    public $boxcode = "mybox";
    public $boximg = "questionnaire@questionnaire";
    public $boxlabel;
    public $depends = array("questionnaire");
    public $db;
    public $param;
    ...
    public function loadBox($max = 5)
    {
        ...
        //include_once DOL_DOCUMENT_ROOT . "/questionnaire/class/questionnaire.class.php";
